          ...
          <div className="flex flex-col sm:flex-row w-full gap-5 sm:gap-10 p-5  rounded-lg">
            <div className="  my-auto  sm:w-30">
              <img
                ...
                src={
                  "https://i.ibb.co.com/fGS5j02b/titash-gas-logo-png-seeklogo-333374.png"
                }
                alt=""
              />
            </div>
            <div className="flex flex-col justify-center  items-center sm:items-start my-auto gap-3">
