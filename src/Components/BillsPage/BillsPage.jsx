  ...
  return (
    <div className="mt-5">
        ...
        <div className="flex justify-center ">
          <div className="dropdown dropdown-bottom dropdown-center">
            <div
              tabIndex={0}
              role="button"
              className="m-1 font-bold border-2 p-2 flex justify-center  rounded-lg w-[214px]"
            >
              Sort By : {select}
            </div>
            <ul
      ...
      {bills.map((bill) => {
        ...
        const tickMark = paid.includes(bill.id);
        return (
          <div
            key={bill.id}
              ...
              <div className="flex flex-col justify-center w-full items-center sm:items-start my-auto gap-3">
                <div className=" flex flex-col gap-2 ">
                  <div className="flex flex-row gap-5 w-full">
                    ...
                    <div className="">
                      {tickMark ? (
                        <h1 className=" text-center my-auto sm:text-start">
                ...
                {tickMark ? (
                  <Link
                    ...
                    className="btn btn-primary bg-green-600 border-none w-full px-20"
                  >
                    Paid
                  </Link>
                ) : (
